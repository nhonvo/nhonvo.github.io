...
description: "Master techniques for identifying and fixing slow SQL queries, including execution plans and indexing."
pubDate: "9 6 2025"
published: true
tags:
  [
...
- **Execution Plan**
  ...
  - **Key Operations to Analyze**:
    - **Table Scan / Clustered Index Scan**: **(Bad on large tables)** Reads the _entire_ table. A major performance bottleneck.
