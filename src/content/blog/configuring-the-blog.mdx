...
set this to your blog url, e.g. `https://nhonvo.github.io`

## BASE

set this to the base path of your blog, e.g. `/algo-blog`
...
- set this to your bluesky handle, e.g. `nhonvo.dev` (without the `@`) will be used to show likes and comments on your blog posts from bluesky 
(see [comments via bluesky](../comments-via-bluesky))

## SOURCE_LINK

- set this to the link to the source code of your blog, e.g. `https://github.com/nhonvo/algo-blog` will be shown in the footer, leave blank to hide
